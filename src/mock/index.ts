...
export const mock = {
  ...
  data: [
    ...
    },
    {
      ...
      displayName: 'Killjoy',
      description:
        'Killjoy, uma alemã genial, defende posições-chave no campo de batalha com uma coleção de armadilhas, torretas e minas. Cada invenção foi desenvolvida para punir qualquer atacante burro o suficiente para não bater em retirada.',
      developerName: 'Killjoy',
      characterTags: ['Confinamento Defensivo', 'Dano em Área'],
      ...
      backgroundGradientColors: ['e6d759ff', '58956aff', 'dd8df8ff', 'f3ab3dff'],
      ...
      abilities: [
        ...
        },
        {
          ...
          description:
            'EQUIPE um Robô de Alarme oculto. DISPARE para ativar um robô que persegue os inimigos que entram no alcance. Ao se aproximar do alvo, o robô explode, aplicando Vulnerável aos inimigos na área. SEGURE EQUIPAR para retirar um robô ativado.',
    ...
    },
    {
      ...
      characterTags: ['Especialista em controle de visão'],
      ...
      backgroundGradientColors: ['51af58ff', '6b8690ff', 'a5ae60ff', 'def2acff'],
      ...
      abilities: [
        {
          ...
          description:
            'EQUIPE um emissor de gás. DISPARE para jogar o emissor, que persiste até o fim da rodada. REPITA para criar uma nuvem de gás tóxico que drena combustível. A habilidade pode ser REPETIDA mais de uma vez e pode ser apanhada para ser REPOSICIONADA.',
        ...
        },
        {
          ...
          description:
            'EQUIPE um lançador de emissores de gás que penetra a área. DISPARE para lançar uma linha de emissores. REPITA a habilidade para criar uma parede alta de gás tóxico que drena combustível. A habilidade pode ser REPETIDA.',
        ...
        },
        {
          ...
          description:
            'EQUIPE um lançador químico. DISPARE para lançar um cilindro que se rompe ao atingir o chão, gerando uma zona química duradoura que causa dano aos inimigos e aplica Vulnerável a eles.',
        ...
        },
        {
          ...
          description:
            'EQUIPE um borrifador químico. DISPARE para borrifar uma nuvem química em todas as direções ao redor de Viper, criando uma grande nuvem que reduz o alcance de visão dos jogadores e a Vida máxima dos inimigos dentro dela. SEGURE a tecla de habilidade para dispersar a nuvem mais cedo.',
        ...
        },
        {
          ...
          displayName: 'Tóxica',
          description:
            'Você gradualmente gera e recupera a toxina que abastece as suas habilidades. Inimigos que atravessarem a Nuvem Venenosa, a Cortina Tóxica ou o Poço Peçonhento da Viper instantaneamente sofrem pelo menos 50 de deterioração. O nível de deterioração deles aumenta quanto mais permanecerem em contato com a toxina.',
          displayIcon: null,
        },
      ],
      voiceLine: {
    ...
    },
    {
      ...
      characterTags: ['Flexibilidade', 'Autossustentação'],
      ...
      backgroundGradientColors: ['f7bf60ff', 'ea6d4eff', '838ea6ff', '7c5b60ff'],
      ...
      abilities: [
        {
          ...
          description:
            'EQUIPE uma parede de fogo. DISPARE para criar uma linha de chamas que avança, gerando uma parede de fogo que bloqueia a visão e causa dano a jogadores que passarem por ela. SEGURE DISPARAR para curvá-la na direção da mira.',
        ...
        },
        {
          ...
          description:
            'EQUIPE uma bola de fogo. DISPARE para jogar a bola de fogo, que explode após um intervalo ou ao atingir o chão, criando uma zona duradoura que causa dano aos inimigos.',
        ...
        },
        {
          ...
          description:
            'INSTANTANEAMENTE coloca um marcador na localização de Phoenix. Com a habilidade ativa, morrer ou deixar o tempo acabar encerrarão a habilidade e trarão Phoenix de volta ao local marcado com Vida completa e a mesma quantidade de armadura que tinha ao ativa-la.',
    ...
    },
    {
      ...
      backgroundGradientColors: ['ef90afff', '4e26c9ff', '7aa1e8ff', 'b0ae84ff'],
      ...
      abilities: [
        ...
        },
        {
          ...
          description:
            'ATIVE a Ultimate para entrar na Forma Astral e use DISPARO para posicionar Estrelas. Atinja as Estrelas com Pulso Nova, Nebulosa ou Poço Gravitacional para utilizar essas habilidades.',
    ...
    },
    {
      ...
      developerName: 'Sarge',
      characterTags: ['Controle de Visão', 'Dano em Área'],
      ...
      backgroundGradientColors: ['b35723ff', '8b81aaff', '5f1c0aff', 'eb953fff'],
      ...
      abilities: [
        {
          ...
          description:
            'INSTANTANEAMENTE arremesse um sinalizador estimulante. Ao pousar, ele criará um campo que concede Tiro Rápido e Impulso de Velocidade aos jogadores.',
        ...
        },
        {
          ...
          description:
            'EQUIPE um mapa tático. DISPARE para marcar locais onde as nuvens de fumaça de Brimstone pousarão. Use o DISPARO ALTERNATIVO para confirmar, lançando nuvens de fumaça de longa duração que bloqueiam a visão na área selecionada.',
    ...
    },
    {
      ...
      backgroundGradientColors: ['efe342ff', '689affff', '9189cbff', '4866e4ff'],
      ...
      abilities: [
        {
          ...
          description:
            'INSTANTANEAMENTE canaliza o poder da Neon para receber velocidade aumentada. Ao atingir a carga máxima, use o DISPARO ALTERNATIVO para acionar um deslize elétrico. O carregamento é redefinido a cada dois abates.',
        ...
        },
        {
          ...
          description:
            'DISPARE duas linhas de energia no chão à frente. As linhas se estendem por uma curta distância ou até atingirem uma superfície. Elas se tornam paredes de eletricidade estática que bloqueiam a visão.',
        ...
        },
        {
          ...
          description:
            'Neon libera todo o seu poder e velocidade por um curto período. DISPARE para canalizar isso em um raio elétrico mortal com alta precisão de movimento.',
    ...
    },
    {
      ...
      backgroundGradientColors: ['e18437ff', '99412aff', '394278ff', '0024f5ff'],
      ...
      abilities: [
        {
          ...
          description:
            'EQUIPE um eco dimensional que se transforma em uma cópia do Yoru quando ativado. DISPARE para ativar a cópia e fazê-la avançar. Use o DISPARO ALTERNATIVO para posicionar um eco inativo. USE para transformar o eco inativo em uma cópia e fazê-la avançar. As cópias explodem e cegam os inimigos quando destruídas por eles.',
    ...
    },
    {
      ...
      characterTags: ['Recuperação', 'Impedimento'],
      ...
      backgroundGradientColors: ['9254b8ff', '67abddff', '66357eff', '78fad8ff'],
      ...
      abilities: [
        ...
        },
        {
          ...
          description:
            'EQUIPE um orbe de barreira. DISPARE para posicionar uma parede que é fortificada após alguns segundos. DISPARO ALTERNATIVO gira o marcador de alvo.',
    ...
    },
    {
      ...
      characterTags: ['Evasão', 'Autossustentação'],
      ...
      backgroundGradientColors: ['ce53a8ff', '2f2664ff', '383b3dff', 'e46c76ff'],
      ...
      abilities: [
        ...
        },
        {
          ...
          description:
            'INSTANTANEAMENTE entra em estado de frenesi, aumentando drasticamente as velocidades de disparo, equipagem e recarga de munição. Ganha cargas infinitas das habilidades de Colheita de Almas. A duração é renovada quando um inimigo morrer para Reyna ou em até 3 segundos após sofrer dano de Reyna.',
    ...
    },
    {
      ...
      characterTags: ['Mobilidade', 'Controle de Visão'],
      ...
      backgroundGradientColors: ['7c7fb4ff', '3e3c56ff', '4a5fa4ff', '59bbc5ff'],
      ...
      abilities: [
        {
          ...
          description:
            'EQUIPE um orbe cegante. DISPARE para lançá-lo, ensurdecendo e reduzindo brevemente o alcance de visão dos jogadores tocados. O projétil atravessa paredes.',
        ...
        },
        {
          ...
          description:
            'EQUIPE um orbe sombrio, entrando num universo distorcido para colocar e alvejar orbes. PRESSIONE o botão de habilidade para lançar o orbe no local marcado, criando uma esfera duradoura que bloqueia visão. Enquanto mira, SEGURE DISPARO para afastar o marcador ou SEGURE O DISPARO ALTERNATIVO para aproximar. PRESSIONE RECARREGAR para alternar para a visão de mira normal.',
    ...
    },
    {
      ...
      developerName: 'Wushu',
      characterTags: ['Evasão', 'Mobilidade'],
      ...
      backgroundGradientColors: ['9edaf6ff', '5266aaff', '2b577cff', '90fcfdff'],
      ...
      abilities: [
        ...
        },
        {
          ...
          description:
            'ATIVE para preparar uma rajada de vento por tempo limitado. REPITA a habilidade para lançar Jett na direção do movimento atual dela. Se estiver parada, Jett será lançada para frente.',
        ...
        },
        {
          ...
          description:
            'INSTANTANEAMENTE lança um projétil que se expande numa breve nuvem que obscurece a visão ao bater numa superfície. SEGURE o botão da habilidade para curvar a fumaça na direção da sua mira.',
        ...
        },
        {
          ...
          description:
            'EQUIPE um conjunto de facas de arremesso. DISPARE para lançar uma única faca contra o alvo e recarregá-las ao matar um oponente. Use o DISPARO ALTERNATIVO para jogar todas as facas restantes contra o alvo, sem a opção de recarregá-las ao matar o oponente.',
